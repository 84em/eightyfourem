...
if ( ! function_exists( 'eightyfourem_block_styles' ) ) :
	/**
...
add_action( 'init', 'eightyfourem_block_styles' );

/**
 * Enqueue block stylesheets.
 */

if ( ! function_exists( 'eightyfourem_block_stylesheets' ) ) :
	/**
...
add_action( 'init', 'eightyfourem_block_stylesheets' );

/**
 * Register pattern categories.
 */

if ( ! function_exists( 'eightyfourem_pattern_categories' ) ) :
	/**
	 * Register pattern categories
	 *
	 * @since Eighty Four EM 1.0
...
add_action( 'init', 'eightyfourem_pattern_categories' );

/**
 * Enqueue theme scripts and styles.
 */
if ( ! function_exists( 'eightyfourem_enqueue_scripts' ) ) :
    /**
...
add_action( 'wp_enqueue_scripts', 'eightyfourem_enqueue_scripts' );
